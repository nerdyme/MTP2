                       ...
                       // exlistView.setEmptyView(View);
                        ...
                        exlistView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                            ...
                            public boolean onChildClick(ExpandableListView parent, View v,
                                ...
                                viewsurvey = (Button) v.findViewById(R.id.viewsurvey);
                                //viewsurvey.setFocusable(false);

                                launchsurvey = (Button) v.findViewById(R.id.launchsurvey);
                                ...
                                viewsurvey.setOnClickListener(new Button.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        Intent i = new Intent(Surveyoptions.this, Viewsurvey.class);
                                        ...
                                        Surveyoptions.this.startActivity(i);
                                ...
                                launchsurvey.setOnClickListener(new Button.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        // TODO Auto-generated method stub
                                        Intent i = new Intent(Surveyoptions.this, ContactOptions.class);
                                        Surveyoptions.this.startActivity(i);
